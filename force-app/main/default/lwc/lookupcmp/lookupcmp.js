...
export default class Lookupcmp extends LightningElement {
    ...
    searchField(event) {
        ...
        //Added for INC0293960,RITM0331423 Date:08 March 2022, Shivansh Yadav
        if(this.sobject=='Product2'){
            if(this.fieldname!='Name,Product_Code__c'){
                this.fieldname =this.fieldname+',Product_Code__c';
            }
        }
        console.log('@@fieldname: ',this.fieldname);
        //End of change for INC0293960,RITM0331423 Date:08 March 2022, Shivansh Yadav
